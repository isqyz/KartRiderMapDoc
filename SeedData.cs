        ...
        internal static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            if (!context.PlayerScores.Any())
            {
                context.PlayerScores.AddRange
                    (
                    new Models.PlayerScore {  Level = Models.ScoreLev.一线 , PlayerName = "富贵", Score = 91.60, TrackName = "城镇高速公路"  },
                    new Models.PlayerScore {  Level = Models.ScoreLev.娱乐 , PlayerName = "土炮", Score = 98.60, TrackName = "城镇高速公路"  }
                );
                context.SaveChanges();
            }
        }
